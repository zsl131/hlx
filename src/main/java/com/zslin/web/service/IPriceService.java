 ...
 */
public interface IPriceService extends BaseRepository<Price, Integer>, JpaSpecificationExecutor<Price> {
    ...
    Price findByStoreSn(String storeSn);

    @Query("FROM Price p WHERE p.storeSn='hlx'")
    Price findByStoreSn();
