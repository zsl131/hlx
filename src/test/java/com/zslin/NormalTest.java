...
//                list.add(new SpecificationOperator());
   ...
   @Test
    ...
    @Test
    public void test51_1() throws Exception {
        BufferedImage bi = ImageIO.read(new File("D:/temp/sign.png"));
        WritableRaster w = bi.getAlphaRaster();

        System.out.println(w);
        System.out.println(w.getNumDataElements());
    }
